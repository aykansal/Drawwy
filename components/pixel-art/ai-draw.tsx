...
export default function AiDraw({
  ...
  return (
    <div className="fixed top-4 left-4 z-50 w-[92vw] max-w-sm sm:max-w-md">
      <Card className="shadow-xl">
        <div className="flex items-center justify-between px-3 py-2 border-b">
          <div className="flex items-center gap-2">
            <Bot className="w-4 h-4" />
            <span className="text-sm font-medium">Draw AI</span>
          </div>
        ...
        <CardContent className="p-0">
          <div ref={viewportRef} className="max-h-[60vh] overflow-y-auto p-3 space-y-2">
            {messages.length === 0 && (
